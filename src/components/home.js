        ...
        <div className='w-full bg-[#eef0f3] py-16 px-4 '> 
            ...
            <img className='hidden lg:flex justify-center items-center w-[500px] h-[400px]  my-4  border-2 border-[#28426b]' src={image1} alt=''/>
                <div className='flex flex-col justify-center '>
                    <p className='text-[#28426b] font-cutive font-bold text-sm mb-4 '>Full Stack Developer</p>
                    
                    <h1 className='md:text-4xl sm:text-3xl text-2xl font-cutive font-bold py-2 mb-2 text-[#3e68bb]' >Hello there!</h1>
            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
                <div className='flex flex-col justify-center '>
                    ...
                    <p className='font-cutive text-sm text-[#28426b] '>
                ...
                <img className='hidden lg:flex justify-center items-center w-[500px] h-[400px] ml-auto my-4 border-2 border-[#28426b]  ' src={HackPic} alt=''/>
            </div>
